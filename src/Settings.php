...
class Settings
{
    ...
    private function fetch($key)
    {
        ...
        $row = $this->database->table($this->config['db_table'])->where('name', $key)->first(['value']);
    ...
    public function set($key, $value)
    {
        ...
        $setting = $this->database->table($this->config['db_table'])->where('name', $key)->first();
    ...
    {
        $this->database->table($this->config['db_table'])->where('name', $key)->delete();
